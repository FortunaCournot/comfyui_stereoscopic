...
---------------------------------------------------
The agent discovers workspace prompts and instructions in `.github/prompts/` and `.github/instructions/`.
...
Notes
-----
- The import script uses heuristics to decide whether a memory should be an instruction (policy/style files) or a prompt (guidance). Review generated files under `.github/prompts/` and `.github/instructions/` before committing.
