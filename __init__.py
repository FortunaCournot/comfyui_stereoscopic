...
if LOAD_ERRORS == 0:
    print(f'\033[34m[comfyui-stereoscopic] v{__version__}\033[0m \033[92mLoaded\033[0m')
else:
    print(f'\033[34m[comfyui-stereoscopic] v{__version__}\033[0m \033[91mLoad failed\033[0m')
