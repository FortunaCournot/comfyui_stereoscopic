...
if [ ! -e "$CONFIGPATH"/"rebuild_autoforward.sh" ] ; then
	...
	echo "echo '[codec_type!=audio]tasks/createsilence' >>output/vr/caption/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo 'tasks/reencode' >>output/vr/caption/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo 'scaling' >>output/vr/caption/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[height>2160]tasks/vlimit-2160p' >>output/vr/scaling/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<60:tvai=true]tasks/vlimit-1080p' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<60:vram>13]tasks/vlimit-1080p' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<20:vram>13:r_frame_rate<31]interpolate'        >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio:duration<20]singleloop'         >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
