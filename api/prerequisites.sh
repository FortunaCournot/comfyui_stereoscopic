...
if [ ! -e "$CONFIGPATH"/"rebuild_autoforward.sh" ] ; then
	...
	echo "echo '[duration<10:tvai=true:width<7681:r_frame_rate<31]interpolate' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<10:tvai=true]tasks/vlimit-1080p' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<10:vram>13]tasks/vlimit-1080p' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<10:vram>13:r_frame_rate<31]interpolate'        >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio:duration<10]singleloop'         >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<10:vram>6:r_frame_rate<31]interpolate'        >>output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio:duration<10]singleloop'         >>output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio]dubbing/sfx'         >>output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<10:width<3841]tasks/credit-vr-we-are' >>output/vr/interpolate/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
