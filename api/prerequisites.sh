...
if [ ! -e "$CONFIGPATH"/"rebuild_autoforward.sh" ] ; then
	...
	echo "# One forward rule per line."  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "# Rule syntax: stagepath  or  [condition:condition:condition...]stagepath"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "# Condition syntax: key OPERATOR value (without spaces)"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "# Video Stream Keys: bit_rate,width,height,r_frame_rate,duration,nb_frames,display_aspect_ratio(*1000)"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "# System Keys: vram(GB),tvai(true/false),sbs(true/false)"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "# Clear forward definitions and rebuild."  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	HEADERCOMMENT="# Autogenerated by "$CONFIGPATH"/rebuild_autoforward.sh - do not edit."
	echo "echo '"$HEADERCOMMENT"' >output/vr/caption/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type=audio]tasks/reencode' >>output/vr/caption/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/reencode/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[tvai=true]tasks/fps-limit-30' >>output/vr/tasks/reencode/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[vram>8]tasks/fps-limit-30' >>output/vr/tasks/reencode/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo 'tasks/fps-limit-15' >>output/vr/tasks/reencode/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/fps-limit-15/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo 'scaling'            >>output/vr/tasks/fps-limit-15/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/fps-limit-30/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo 'scaling'            >>output/vr/tasks/fps-limit-30/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/scaling/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false:height>2160]tasks/vlimit-2160p' >>output/vr/scaling/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false:duration>90]tasks/vlimit-1080p' >>output/vr/scaling/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false]fullsbs' >>output/vr/scaling/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/vlimit-2160p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false]fullsbs'            >>output/vr/tasks/vlimit-2160p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<1]watermark/encrypt' >>output/vr/tasks/vlimit-2160p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false]fullsbs'            >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<1]watermark/encrypt' >>output/vr/tasks/vlimit-1080p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<60:sbs=true]tasks/credit-vr-we-are' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<1]tasks/vlimit-2160p' >>output/vr/fullsbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "# 8 VRAM or less will get no interpolation for now, until we find a better solution."  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<20:vram>6:r_frame_rate<31]interpolate'        >>output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio:duration<20]singleloop'         >>output/vr/tasks/vlimit-720p/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[r_frame_rate<31]interpolate'         >>output/vr/interpolate/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[sbs=true:width<3841]tasks/pad-16-9-sbs' >>output/vr/interpolate/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/singleloop/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[codec_type!=audio]dubbing/sfx'        >>output/vr/singleloop/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	...
	echo "echo '[duration<60:sbs=true]tasks/credit-vr-we-are' >>output/vr/dubbing/sfx/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[duration<60:sbs=false]tasks/credit-no-sbs' >>output/vr/dubbing/sfx/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo ""  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '"$HEADERCOMMENT"' >output/vr/tasks/pad-16-9-sbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=true]tasks/credit-vr-we-are' >>output/vr/tasks/pad-16-9-sbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
	echo "echo '[sbs=false]tasks/credit-no-sbs' >>output/vr/tasks/pad-16-9-sbs/forward.txt"  >>"$CONFIGPATH"/"rebuild_autoforward.sh"
...
if [ ! -e "$CONFIGPATH"/uml/"autoforward.pu" ] || [ "$CONFIGPATH"/uml/"autoforward.pu" -ot "$CONFIGPATH"/"rebuild_autoforward.sh" ] ; then
