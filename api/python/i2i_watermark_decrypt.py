...
if len(sys.argv) != 4 + 1:
   print("Invalid arguments were given ("+ str(len(sys.argv)-1) +"). Usage: python " + sys.argv[0] + " OriginalImagePath EncryptedImagePath WatermarkOutputPathPrefix secret")
else:
