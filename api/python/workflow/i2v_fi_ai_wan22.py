...
if len(sys.argv) != 5 + 1:
   print("Invalid arguments were given ("+ str(len(sys.argv)-1) +"). Usage: python " + sys.argv[0] + " apifile StartImagePath OutputPathPrefix Prompt ActorImagePath")
else:
    ...
    prompt["78"]["inputs"]["image"] = sys.argv[5]
